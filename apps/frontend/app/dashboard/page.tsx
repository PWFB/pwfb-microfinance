    ...
    <main className={styles.dashboard}>
      ...
      <section className={styles.grid}>
        ...
        <aside className={styles.stack}>
          ...
          <div className={styles.panel}><div className={styles.panelHead}><div><small>OPERATIONS</small><h2>Quick Actions</h2></div></div><div className={styles.shortcuts}><Link href="/banking?operation=deposit" className={`${styles.shortcut} ${styles.shortcutBanking}`}><b>₦</b><span>Deposit</span></Link><Link href="/banking?operation=withdraw" className={`${styles.shortcut} ${styles.shortcutBanking}`}><b>−</b><span>Withdrawal</span></Link><Link href="/banking?operation=transfer" className={`${styles.shortcut} ${styles.shortcutBanking}`}><b>↔</b><span>Transfer</span></Link><Link href="/loans/add" className={styles.shortcut}><b>↗</b><span>New Loan</span></Link><Link href="/repayments/add" className={styles.shortcut}><b>↻</b><span>Receive Payment</span></Link><Link href="/customers/add" className={styles.shortcut}><b>+</b><span>Add Customer</span></Link></div></div>
        </aside>
      </section>
