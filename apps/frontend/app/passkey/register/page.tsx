...
export default function RegisterPasskeyPage() {
  ...
  async function register() {
    ...
    try {
      ...
      if (!("credentials" in navigator) || !("PublicKeyCredential" in window)) throw new Error("This browser cannot register passkeys. Open PWFB in Chrome on this phone and try again.");
