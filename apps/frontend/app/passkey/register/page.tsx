...
export default function RegisterPasskeyPage() {
  ...
  async function register() {
    setLoading(true); setError(""); setStatus(newDevice ? "Preparing a new passkey for this phone…" : "Preparing secure passkey registration…");
    try {
      ...
      setStatus("Follow the prompt on this phone to save your fingerprint/passkey.");
      ...
      if (e?.name === "NotAllowedError") setError("Passkey setup was cancelled. Tap Register Passkey to try again.");
