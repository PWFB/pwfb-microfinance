...
export default function PermissionsPage() {
  ...
  async function load() {
    try {
      setError("");
      setLoading(true);
      const data = await pwfbApi.permissions.list();
  ...
  async function toggle(role: string, permission: string, enabled: boolean) {
    ...
    try {
      await pwfbApi.permissions.update({ role, permission, enabled });
    } catch (e: any) {
