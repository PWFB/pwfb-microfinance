...
export default function RepaymentsPage() {
  ...
  useEffect(() => {
    fetch(`${API_URL}/repayments`).then((res) => res.ok ? res.json() : []).then((data) => setRepayments(Array.isArray(data) ? data : [])).catch(() => setRepayments([])).finally(() => setLoading(false));
  }, []);
