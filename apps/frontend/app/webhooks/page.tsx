...
const events = [
  ...
  { name: "Paystack payments", path: "/banking/webhooks/paystack", tone: "orange", description: "Receive signed Paystack charge events and process eligible successful payments." },
  { name: "Virtual account events", path: "/banking/webhooks/virtual-account", tone: "green", description: "Provider-neutral boundary for customer virtual-account notifications." },
  { name: "Wallet withdrawal events", path: "/banking/webhooks/wallet-withdrawal", tone: "orange", description: "Reconcile withdrawal status updates using the PWFB webhook secret." },
];
